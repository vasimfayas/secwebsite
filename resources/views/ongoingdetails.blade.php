...
<div class="flex justify-between items-center mt-14 border-t pt-6">
    ...
    @if($prev)
    <a href="{{ route('ongoingdetails', $prev->id) }}"
    ...
    @if($next)
    <a href="{{ route('ongoingdetails', $next->id) }}"
       class="group flex items-center gap-2 text-gray-600 hover:text-red-600 transition">
    ...
    @endif
        ...
        <div class="text-center">
            <a href="{{ route('ongoingProjects')}}" class="inline-block px-6 py-2 bg-red-600 text-white font-semibold rounded hover:bg-red-700 transition mt-5">
                ← Back 
            </a>
